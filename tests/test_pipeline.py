...
def test_regime_expansion():
    ...
    assert regime.regime == "Reflationary Expansion"
...
def test_sieve_respects_override_settings():
    stock = sample_stock(pe=22, growth_rate=22)
    passed, _ = phase2_sieve(stock, settings={"peg_max": 0.8})
    assert passed is False
